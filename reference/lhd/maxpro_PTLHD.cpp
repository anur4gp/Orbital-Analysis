...
// [[Rcpp::export]]
List pt_maxpro_lhd(int n, int k, int M, int Nmax, int Nswap, int tolerance){
    ...
    ////////////////////// Initialize temp 0 /////////////////////////
    // calculations for temperature schedule
    double crit1 = 1.0 / (n-1);
    double crit2 = pow(1.0 / (pow(n - 1, k -1) * (n-2)),1.0/k);
    double delta0 = crit2 - crit1;
